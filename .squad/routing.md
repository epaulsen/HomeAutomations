...
|-----------|----------|----------|
| Architecture & code review | Motoko | Design proposals, PR reviews, scope decisions, dependency choices |
| .NET automation implementation | Batou | New NetDaemon apps, C# services, models, refactoring |
| IoT/integration work | Togusa | MQTT topics, HA WebSocket, HTTP clients, Docker networking |
| Test writing & QA | Ishikawa | Unit tests, edge cases, test coverage, Moq setup |
| Code review | Motoko | Review PRs, check quality, suggest improvements |
| Scope & priorities | Motoko | What to build next, trade-offs, decisions |
