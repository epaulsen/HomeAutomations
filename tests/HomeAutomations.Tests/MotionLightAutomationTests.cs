...
public class MotionLightAutomationTests
{
    [Fact]
    public void Constructor_ShouldLogInitialization()
    {
        ...
        var mockLogger = new Mock<ILogger<MotionLightAutomation>>();
        ...
        // Act
        var automation = new MotionLightAutomation(mockHaContext.Object, mockLogger.Object);
        ...
        mockLogger.Verify(
            x => x.Log(
                ...
                It.IsAny<EventId>(),
                It.Is<It.IsAnyType>((o, t) => o.ToString()!.Contains("MotionLightAutomation initialized")),
                null,
